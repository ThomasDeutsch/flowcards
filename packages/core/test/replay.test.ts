...
test("a thread can be replayed", (done) => {
    ...
    const thread1 = flow({name: 'thread1'}, function* () {
        ...
        console.log('TRIGGERED A:', value1);
    ...
    const [_, replay] = testScenarios((enable) => {
        ...
        console.log('ACTIN LOG: ', log.actions)
    ...
    replay([
        ...
        {id: 1, type: ActionType.requested, bThreadId: {name: 'thread1'}, eventId: {name: 'requestingEventA'}, payload: delay(100, 10), resolveActionId: null},
        {id: 2, type: ActionType.resolved, bThreadId: {name: 'thread1'}, eventId: {name: 'requestingEventA'}, payload: 1},
...
//         {id: 1, type: ActionType.requested, bThreadId: {name: 'thread1'}, eventId: {name: 'replayEvent2'}, payload: GET_VALUE_FROM_BTHREAD}])
// });
...
//     replay([
//         {id: 0, type: ActionType.ui, bThreadId: {name: ''}, eventId: {name: 'replayEvent1'}},
//         {id: 1, type: ActionType.requested, bThreadId: {name: 'thread1'}, eventId: {name: 'replayEvent2'}, resolveLoopIndex: 2, payload: GET_VALUE_FROM_BTHREAD},
...
//     replay([
//         {id: 0, type: ActionType.ui, bThreadId: {name: ''}, eventId: {name: 'replayEvent1'}},
//         {id: 1, type: ActionType.requested, bThreadId: {name: 'thread1'}, eventId: {name: 'requestEvent1'}}])
// });